...
<body>
  ...
  <div id="info-hand" class="info-app" >
      ...
      <div class="hand-dd-tabs" style="margin-top:0px;">
        <ul>
          <li id="usersynlog" onclick="userSynLog();" class="active"> <i class="fa fa-tips"></i>用户同步日志</li>
          <li id="orgsynlog" onclick="orgSynLog();"><i class="fa fa-tips"></i>组织同步日志</li>
        </ul>
      </div>
  ...
  <script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var url = "<%=realpath%>/weixinplatform/loadWeiXinSynuserlogData.controller?pageSize="+pageSize+"&userorgflag=0";
	...
	function goPage(p){
		...
		//每页的显示数。根据下拉选择框而定。
		var pageSize = $("#page_size option:selected").val();
		var url = "<%=realpath%>/weixinplatform/loadWeiXinSynuserlogData.controller?startPage="+page+"&pageSize="+pageSize+"&userorgflag=0";
		loadViewDataList(url);
	}
	...
	function pageClick(curpage){
		...
		//每页的显示数。根据下拉选择框而定。
		var pageSize = $("#page_size option:selected").val();
		var url ="<%=realpath%>/weixinplatform/loadWeiXinSynuserlogData.controller?pageSize="+pageSize+"&startPage="+curpage+"&userorgflag=0";
		loadViewDataList(url);
	}
	...
	function exportData(){
		...
		var db = $('#data-bsday').val();
		var de = $('#data-bsday2').val();
		var url = "<%=realpath%>/weixinplatform/exportData.controller?dateBegin="+db+"&dateEnd="+de+"&userorgflag=0";
		window.location = url;
	}
